...
export const ICONS: Record<string, string> = {
  ...
  location:
    "https://res.cloudinary.com/dabhuzbsm/image/upload/v1770917703/location_ayiggy.png",
  calendar:
    "https://res.cloudinary.com/dabhuzbsm/image/upload/v1770917694/calendar_yknaas.png",
  box: "https://res.cloudinary.com/dabhuzbsm/image/upload/v1770917694/box_nn8zzi.png",
  documents:
    "https://res.cloudinary.com/dabhuzbsm/image/upload/v1770917697/documents_jgulna.png",
  house:
    "https://res.cloudinary.com/dabhuzbsm/image/upload/v1770917698/house_agizcp.png",
  payment:
...
export const SOCIAL_ICONS: Record<string, string> = {
  ...
  instagram:
    "https://mailsend-email-assets.mailtrap.io/44u4o66kgfizq7okplzxuzxcwqrl.png",
  facebook:
    "https://mailsend-email-assets.mailtrap.io/ivu8ql6l7ktsgrurv27q3bb5j4pj.png",
};
